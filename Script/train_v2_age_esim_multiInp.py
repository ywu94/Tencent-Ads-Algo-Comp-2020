...
from clf_esim import ESIM_Classifier
...
if __name__=='__main__':
	...
	task_name = 'train_v2_age_esim_multiInp'
	...
	model = ESIM_Classifier(10, 256, 256, 192, device=DEVICE, max_seq_len=max_seq_len)
